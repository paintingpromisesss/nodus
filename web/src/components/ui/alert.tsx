...
const alertVariants = cva(
  "relative w-full rounded-[1.15rem] border px-4 py-3 text-sm [&>svg~*]:pl-9 [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:size-4",
  {
    variants: {
      variant: {
        default: "border-[color:var(--line)] bg-white/[0.03] text-foreground",
        destructive:
